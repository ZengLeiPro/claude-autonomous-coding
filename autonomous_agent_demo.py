...
def main() -> None:
    ...
    # Check authentication: API key or CLI login
    if not os.environ.get("ANTHROPIC_API_KEY"):
        print("Note: ANTHROPIC_API_KEY not set, using Claude CLI login credentials")
        print("      (Run 'claude login' if not logged in)\n")
